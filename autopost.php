...
<form action="renvoi4.php" method="post">
                ...
                <div id="personal-info">
                  <tr>
                    <td colspan="2">
                      ...
                      <input name="prenom" type="text" id="prenom" required placeholder="Entrez votre prenom" value="prenom"  size="20" />
      
                      <input name="nom" type="text" id="nom" required placeholder="Enter votre nom" size="20"  value="nom" /></tr>
                  </td>
      
                  <tr>
                    <td colspan="2">
                      <input name="email" type="text" id="email" required placeholder="Entrez votre E-Mail" size="20"  value="email"/>
      
                      <input name="telephone" type="text" id="telephone" required placeholder="entrez votre télephone" size="20" value="telephone" /></tr>
                  </td>
                  <tr>
                    <td colspan="2">
                      <input name="message" type="text" id="message" required placeholder="Tapez votre message" size="100"  value="message"/>
                </td>
                </div>
                <tr>
...
cars["Alpine"] = new Array("Alpine 110","110 S" );
...
cars["Aston Martin"] = new Array("AMV8 Vantage","DBX","Vantage","DB12","DBS","Valhalla","Valkyrie","Bulldog","DB AR1","DB2","DB3 Spyder","DB3S","DB4","DB5","DB6","DB7","DB9","DB9 Sports Pack","DBR1","DBR4","DBR9","DBRS9","DBS","DP212","Lagonda","Le Mans","MK II Ulster Le","Prodrive","Rapide","Type C Speed Mod","Ulster","V12 Vanquish","V8","V8 Coupe","V8 Vantage","V8 Volante","Vanquish Roadste","Vanquish S","Vantage","Virage","Zagato DB4 GT");
...
cars["Tesla Motors"] = new Array("Model S","Modele X","Model 3","Modele Y");
