...
<li class="li.search__product-item"><!--cellule des images descriptions-->
    <product-slot class="product-slot.product-slot.slot-element.js-carousel-item.product-slot--hero" name="911turbos" id="911turbos"
    ...
    <article>
        <div class="product-slot__image image-wrapper">                                                        
            <li class="product-slot-image-active" role="group" aria-label="1 / 1" aria-hidden="true" style="width: auto;">                                 
                ...
                //https://911andco.fr/wp-content/uploads/2017/06/porsche_911_turbo_s_exclusive_series_2017_04-une.jpg 960w" id="911turbos" title="911 Turbo S"/>
            </a>
        </li>
    </div>
    ...
    <div class="product-slot__skeleton product-slot__skeleton--price"></div>
        <div class="product-slot__skeleton product-slot__skeleton--quick-view"></div>
            <product-price class="product-price" data-element="product-price" data-model="{}" data-scope="200" id="911turbos" name="911turbos" value="turbos">                           
